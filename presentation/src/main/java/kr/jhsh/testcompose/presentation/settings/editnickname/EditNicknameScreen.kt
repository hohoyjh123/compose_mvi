...
fun EditNicknameScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                trailingIcon = {
                    if (state.newNickname.isNotEmpty()) {
                        IconButton(
                            onClick = { viewModel.handleIntent(EditNicknameIntent.OnClearNickname) }
                        ) {
                            Icon(
            ...
            if (state.validationMessage.isNotEmpty()) {
                ...
                Text(
                    ...
                    color = if (state.isValidationSuccess) {
                        ...
                        MaterialTheme.colorScheme.error // 빨간색
                    },
            ...
            // 저장 버튼
            Button(
                onClick = { viewModel.handleIntent(EditNicknameIntent.OnSaveNickname) },
                modifier = Modifier.fillMaxWidth(),
